...
describe('Super Bonus Quest - betterGreatestProduct', () => {
  test('should declare a function named betterGreatestProduct', () => {
    expect(typeof betterGreatestProduct).toBe('function');
  });
  ...
  test('should return 1 (one) when all numbers of the arrays are 1', () => {
    ...
    expect(betterGreatestProduct(matrix)).toBe(1);
  });
  ...
  test('should return 16 when all the numbers of the arrays are 2', () => {
    ...
    expect(betterGreatestProduct(matrix)).toBe(16);
  });
  test('should return 160000 when greatest product is in a line', () => {
    let matrix = [
      [1, 1, 1, 1, 1],
      [1, 20, 20, 20, 20],
      [1, 1, 1, 1, 1],
    ...
    expect(betterGreatestProduct(matrix)).toBe(160000);
  });
  test('should return 160000 when greatest product is in a column', () => {
    let matrix = [
      [1, 1, 1, 1, 1],
      [20, 1, 1, 1, 1],
      [20, 1, 1, 1, 1],
  ...
  test('should return 160000 when greatest product is in a diagonal', () => {
    let matrix = [
      [1, 1, 1, 1, 1],
      [1, 20, 1, 1, 1],
      [1, 1, 20, 1, 1],
  ...
  test('should return 32000 when all the numbers of the arrays mixed', () => {
    ...
    expect(betterGreatestProduct(matrix)).toBe(32000);
  });
});
